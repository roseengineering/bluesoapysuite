...
includes two ansible playbook for installing the suite on
the Raspberry Pi.  The playbooks are called bluesoap.yml and bluepps.yml.
The playbook itself is generated by running the python scripts bluesoap.py
and bluepps.py.
